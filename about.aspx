<%@ Page Title="" Language="C#" MasterPageFile="~/HomepageFooter.Master" CodeFile="~/about.aspx.cs" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="trial.about" %>
                ...
                <div class="row">
                   <%-- <div class="col-sm-5 vertical-align">
                    ...
                    <div class="col-sm-7 vertical-align">
                        ...
                        <p>Our Mission is to help farmers get the correct price for their produce thereby eliminating middlemen cost.The retailer and customers also gets benefit by getting fresh produce. The farmers not only can sell their produce but can also register for various schemes. </p>
