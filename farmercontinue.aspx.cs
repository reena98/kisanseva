...
namespace trial
{
    public partial class farmercontinue : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("farmercontinue.aspx?cat=Axe");
        }

        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            Response.Redirect("farmercontinue.aspx?cat=Plough");
        }
        ...
        {
            Response.Redirect("farmercontinue.aspx?cat=Sickle");
        }
    }
}