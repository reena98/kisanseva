...
namespace trial.Farmer
{
    public partial class AddProduct : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into productdetail(productid,productname,price,productimage,stockavailable,description,category) values(" + Label1.Text + ",'" + TextBox1.Text + "','" + TextBox2.Text + "','" + link + "','"+TextBox3.Text+"','"+TextBox4.Text+"','"+DropDownList1.SelectedItem.ToString()+"')";
