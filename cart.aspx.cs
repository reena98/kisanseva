...
namespace trial
{
    ...
    **/
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            //    string productname = (((Label)row.FindControl("lblname")).Text);
            //    float price = Convert.ToInt32(((Label)row.FindControl("lblPrice")).Text);
            ...
            //    cmd.ExecuteNonQuery();
            //    con.Close();
            //    Response.Redirect("checkoutview.aspx");
