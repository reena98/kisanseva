				...
				<div class="tho-option-switcher">
					<div class="tho-option-switcher-btn tho-icon-option">
						...
						<div class="tho-option-swticher-body">
							...
							<span class="tho-subtitle">RTL Options</span>
							<div class="no-col-space">
								<a href="javascript:void(0);" class="tho-btn left-to-right tho-active-switcher-btn">LTR</a>
								<a href="javascript:void(0);" class="tho-btn right-to-left">RTL</a>
							</div>
						</div>
				</div>
