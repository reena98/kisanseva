...
namespace trial
{
    public partial class continueshop : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    Dlshop.DataSourceID = null;
                    Dlshop.DataSource = SqlDataSource4;
                    Dlshop.DataBind();
                }
            }
    ...
    //        }
        ...
        protected void Dlshop_UpdateCommand(object source, DataListCommandEventArgs e)
        {
        ...
        {
            Dlshop.DataSourceID = null;
            Dlshop.DataSource = SqlDataSource3;
            Dlshop.DataBind();
        }

        //protected void LinkButton1_Click(object sender, EventArgs e)
        //{
        //    Response.Redirect("continueshop.aspx?cat=Dal");
        //}

        //protected void LinkButton2_Click(object sender, EventArgs e)
        //{
        //    Response.Redirect("continueshop.aspx?cat=Grains");
        //}
        ...
        {
            Response.Redirect("continueshop.aspx?cat=Rice");
        }

        protected void LinkButton2_Click1(object sender, EventArgs e)
        {
            Response.Redirect("continueshop.aspx?cat=Pulses");
        }
