<%@ Page Title="" Language="C#" MasterPageFile="~/Farmers.Master" CodeFile="~/checkout.aspx.cs" AutoEventWireup="true" CodeBehind="checkout.aspx.cs" Inherits="trial.checkout" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="widget">
                ...
                <ul class="list list-unstyled">
                    ...
                    <li class="active">
                        <a href="cart.aspx">My Cart <span class="text-primary">
        ...
        <div class="col-sm-9">
            <div class="row">
                <div class="col-sm-12 text-left" style="left: 0px; top: -342px">
                        ...
                        <div class="tab-pane" id="billing-info">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="txtrev" runat="server" class="form-control" name="Notes about yout order" TextMode="MultiLine"></asp:TextBox>
                                         </div>
